...
<div id="toolbar">
    ...
    <a href="#" class="easyui-linkbutton" iconCls="icon-permission" plain="true" onclick="addPower()">权限配置</a>
</div>
<table id="dg" title="用户信息" class="easyui-datagrid" style="width:98.8%;"
    ...
    <thead>
        <tr>
            ...
            <th field="roleId" width="40">编号</th>
            <th field="roleName" width="40">名称</th>
            <th field="authIds" width="40">菜单</th>
            <th field="roleDescription" width="40">描述</th>
        </tr>
    </thead>
</table>
    	...
    	<table>
    		...
    		<tr>
	    		<td><label>用户:</label></td>
					<td><input class="easyui-combobox" id="cc" name="user"  
					   url="findUser.do" valueField="userId" textField="userName" multiple="false">
				</td>
    		</tr>
