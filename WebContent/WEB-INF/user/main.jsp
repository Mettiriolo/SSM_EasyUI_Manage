...
<script type="text/javascript">
	$(function(){
		$("#tree").tree({
			lines:true,
			url:'${pageContext.request.contextPath }/auth/menu.do',
		...
		function openTab(node){
			if($("#tabs").tabs("exists",node.text)){
				...
				var content="<iframe frameborder=0 scrolling='auto' style='width:100%;height:100%' src=../html/"+node.attributes.authPath+"></iframe>"
				$("#tabs").tabs("add",{
					title:node.text,
...
<table>
	<tr>
		<td><img src="${pageContext.request.contextPath}/images/mainlogo.png"/></td>
...
<div region="south" style="height: 25px;padding: 5px;" align="center">
	版权所有 纵拓互联 <a href="#" target="_blank">http://www.yalinet.cn</a>
</div>
